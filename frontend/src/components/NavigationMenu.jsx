    ...
    <>
      <div className="w-[250px] min-h-screen bg-[#093c1aff] fixed z-15 max-[1025px]:min-h-full max-[1025px]:w-[300px] max-[321px]:w-[320px] max-[426px]:w-[250px]">
        <div className="flex gap-2 px-5">
          ...
          <p className="font-bold text-[22px] pt-6 max-[321px]:text-[18px] max-[426px]:mt-1 text-white">
            Campfire
          </p>
        </div>
        <div>
          <div className="mt-10">
            ...
            >
              ...
              <h1 className="font-bold text-[22px] -mt-1 text-white">
                Explore
              </h1>
            </button>
          </div>
          ...
          <div className="mt-5">
            ...
            >
              <RiTeamFill size={25} color="white" />
              <h1 className="font-bold text-[22px] -mt-1 text-white">
                My Party
              </h1>
            </button>
